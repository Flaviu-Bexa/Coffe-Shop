        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (!CheckTextBoxesValues())
            {
                ...
                if (txtPassword.Text.Equals(txtPasswordConfirm.Text))
                {
                    ...
                    if (CheckUsername())
                    {
                        MessageBox.Show("Numele de utilizator deja existent", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        //execute the query
                ...
                {
                    MessageBox.Show("Parolele nu sunt indentice", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
